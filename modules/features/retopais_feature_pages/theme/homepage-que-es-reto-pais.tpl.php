  ...
  <div class="que-es-reto-pais--container-inner">
    <div class="que-es-reto-pais--left">
      ...
      <p class="que-es-reto-pais--description">
        <span class="homepage-highlighted">Reto PAÍS</span> es un esfuerzo nacional para invitar a todos los ciudadanos y ciudadanas a <span class="homepage-highlighted">proponer soluciones innovadoras para cuatro problemáticas</span> que nos afectan a nivel país. Cualquier persona con una idea o una solución en marcha puede participar. Las mejores ideas serán seleccionadas como ganadoras y se les dará apoyo para desarrollarlas.
      </p>
